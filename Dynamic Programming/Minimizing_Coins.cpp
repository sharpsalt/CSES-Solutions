...
// Beginner FastIO-BFastIO , Pragmas-Prgama , Z-Algorithm-Z-Algorithm , Z-Function-Z-Func
...
void solve()
{
  ...
  dp[0]=0;
  //dp[1] ke liye kuch nhi kehskte coz we dont d=know the coins
  for(int i=1;i<=x;i++)
  {
    // dp[i]=min(dp[i],dp[i-])
    int mini=INT_MAX;
